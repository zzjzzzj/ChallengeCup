...
def raise_missing_models(inspections: Sequence[Dict[str, Any]]) -> None:
    ...
    lines.extend(
        [
            "",
            "Put the three files under project-root models/ or deployment/ascend310bpro/models/,",
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("outputs/ascend310bpro"))
