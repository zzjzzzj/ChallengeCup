...
CROPS_AUG = ROOT / "target_classifier_module/artifacts/target_crops_augmented"
MANIFEST_SRC = CROPS_AUG / "manifest.csv"
MANIFEST_AUG = CROPS_AUG / "manifest_aug.csv"
MANIFEST_NOAUG = CROPS_AUG / "manifest_noaug.csv"
RESNET_RUNS = ROOT / "target_classifier_module/runs"
YOLO_RUNS = ROOT / "detector_module/runs"
            ...
            specs.append(
                {
                    ...
                    "cmd": [
                        ...
                        sys.executable, "-u", "-m", "target_classifier_module.train_classifier",
            ...
            specs.append(
                {
                    ...
                    "cmd": [
                        sys.executable, "-m", "detector_module.train_detector_ablation",
                        "--data", str(ROOT / "detector_module/configs" / yaml_name),
                        "--name", name,
