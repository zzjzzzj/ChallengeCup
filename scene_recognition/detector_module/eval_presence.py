...
（该类取全图最高置信度作为该类分数），再复用 scene_recognition.target_classifier_module.whole_image
...
DEFAULT_MANIFEST_DIR = (
    PROJECT_ROOT / "scene_recognition" / "detector_module" / "artifacts" / "detection_dataset" / "manifests"
)
...
def evaluate_presence(
    ...
    report = {
        ...
        "threshold_rule": (
            "复用 scene_recognition.target_classifier_module.whole_image.optimize_thresholds，"
