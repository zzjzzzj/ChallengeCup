...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "scene_recognition/target_classifier_module/train_classifier.py 对齐）。"
...
def resolve_model_spec(model: str | None, no_pretrained: bool) -> tuple[str, bool]:
    ...
    实测（ultralytics 8.4.100，见 scene_recognition/detector_module/tests/test_train_detector_scratch.py 的注释）：
...
def main() -> None:
    ...
    if not args.data.is_file():
        raise FileNotFoundError(
            ...
            "请先运行 python -m scene_recognition.detector_module.prepare_detection_dataset"
        )
