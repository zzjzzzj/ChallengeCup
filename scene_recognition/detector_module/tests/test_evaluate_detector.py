...
from scene_recognition.detector_module.dataset import DetectionSample
from scene_recognition.detector_module.evaluate_detector import build_evaluation_slices
