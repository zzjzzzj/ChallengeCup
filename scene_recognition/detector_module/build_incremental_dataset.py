...
from scene_recognition.detector_module.boxes import YoloBox, parse_yolo_boxes
from scene_recognition.detector_module.create_incremental_protocol import build_protocol, parse_class_list
...
DEFAULT_PROTOCOL = PROJECT_ROOT / "scene_recognition" / "detector_module" / "configs" / "incremental_protocol.json"
DEFAULT_OUTPUT = PROJECT_ROOT / "scene_recognition" / "detector_module" / "artifacts" / "incremental_dataset"
