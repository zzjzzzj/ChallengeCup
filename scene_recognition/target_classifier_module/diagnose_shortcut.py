...
用法::
    ...
    python -m scene_recognition.target_classifier_module.diagnose_shortcut \
      ...
      --checkpoint scene_recognition/target_classifier_module/runs/<run>/best.pt \
...
def pixel_ablation(
    ...
    from scene_recognition.target_classifier_module.whole_image import compute_multilabel_metrics
